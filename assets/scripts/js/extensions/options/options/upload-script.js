...
(() => {
/*!****************************************************************!*\
  !*** ./assets/scripts/ts/extensions/options/options/upload.ts ***!
  \****************************************************************/
...
(function ($) {
    ...
    var Upload = /** @class */ (function () {
        ...
        Upload.prototype._uploadItem = function () {
            ...
            var $thisClass = this;
            this.$_upload.on("click", ".dht-upload-item-button", function () {
                var $this = $(this);
        ...
        Upload.prototype._removeItemOnInput = function () {
            this.$_upload.on("input", ".dht-upload-item", function () {
                var $this = $(this);
