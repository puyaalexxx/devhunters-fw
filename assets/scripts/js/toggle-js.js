...
(() => {
/*!****************************************************************!*\
  !*** ./assets/scripts/ts/extensions/options/toggles/toggle.ts ***!
  \****************************************************************/
...
(function ($) {
    ...
    var Toggle = /** @class */ (function () {
        ...
        Toggle.prototype._initToggle = function () {
            ...
            this.$_toggle.off("click", ".dht-toggle").on("click", ".dht-toggle", function () {
                var $toggle = $(this);
                var $toggleInput = $toggle.children("input");
                if ($toggle.hasClass("dht-slider-on")) {
                    $toggle.removeClass("dht-slider-on").addClass("dht-slider-off");
                    //get off value
                    var value = $toggle.children(".dht-slider").children(".dht-slider-no").attr("data-value");
                    $toggleInput.val(value);
                }
                else {
                    $toggle.removeClass("dht-slider-off").addClass("dht-slider-on");
                    //get on value
                    var value = $toggle.children(".dht-slider").children(".dht-slider-yes").attr("data-value");
                    $toggleInput.val(value);
                }
         ...
         * @return void
         */
        Toggle.prototype._showHideOptions = function ($toggle) {
            var input_value = $toggle.children("input").attr("value");
    ...
    function init() {
        $(".dht-field-child-toggle").each(function () {
            new Toggle($(this));
        });
    }
...
/******/ })()
;
//# sourceMappingURL=toggle-js.js.map