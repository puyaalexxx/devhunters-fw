...
(() => {
/*!*********************************************************************!*\
  !*** ./assets/scripts/ts/extensions/options/fields/upload-image.ts ***!
  \*********************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initializetUploadImage: () => (/* binding */ initializetUploadImage)
/* harmony export */ });
...
var UploadImage = /** @class */ (function () {
    ...
    UploadImage.prototype._uploadImage = function () {
        ...
        this.$_uploadImage.off("click", ".dht-upload-image-button").on("click", ".dht-upload-image-button", function () {
            ...
            var $hidden_input = $this.siblings(".dht-upload-hidden");
...
function initializetUploadImage() {
    //init each upload image button option
    function init() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".dht-field-child-upload-image").each(function () {
            new UploadImage(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
        });
    }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("dht_uploadImageAjaxComplete", function () {
        init();
    });
}
...
/******/ })()
;
//# sourceMappingURL=upload-image-js.js.map