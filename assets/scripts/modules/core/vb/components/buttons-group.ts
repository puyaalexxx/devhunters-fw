            ...
            const buttonsGroupHTML = `
                <div class="dht-vb-buttons-group-container">
                    <div class="dht-vb-button-group">
                        <button type="button" class="dht-vb-button dht-vb-icon-drag">
                        ...
                        <button type="button" class="dht-vb-button dht-vb-icon-setting">
                            <div class="dht-vb-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <button type="button" class="dht-vb-button dht-vb-icon-duplicate">
                            <div class="dht-vb-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <button type="button" class="dht-vb-button dht-vb-icon-delete">
                            <div class="dht-vb-icon">
                        ...
                        <button type="button" class="dht-vb-button dht-vb-icon-other-setting">
                            <div class="dht-vb-icon">
