    ...
    class Typography {
        ...
        _fontDropdown($thisClass) {
            ...
            this.$_fonts_dropdown.on("change.mychange", function () {
                ...
                const font_family = String($selected_font.val()).replace(new RegExp(`^${$thisClass._font_prefix}-`), "");
         ...
         * @return void
         */
        _googleFontsManipulations($thisClass, $selected_font, font_family) {
         ...
         * @return void
         */
        _diviFontsManipulations($thisClass, $selected_font, font_family) {
            //set font type input value
         ...
         * @return void
         */
        _standardFontsManipulations($thisClass, $selected_font) {
            //set font type input value
         ...
         * @return void
         */
        _fontWeightsDropdown($thisClass) {
            ...
            this.$_font_weight_dropdown.off("change.mychange").on("change.mychange", function () {
                ...
                if (font_weight.length !== 0) {
                    const fontLink = "https://fonts.googleapis.com/css?family=" + $thisClass._selected_google_font_name.replace(/\s+/g, "+") + ":" + font_weight;
         ...
         * @return void
         */
        _fontSubsetsDropdown($thisClass) {
         ...
         * @return void
         */
        _textTransformDropdown($thisClass) {
         ...
         * @return void
         */
        _textDecorationDropdown($thisClass) {
         ...
         * @return void
         */
        _populateFontWeightDropdown($thisClass, $selected_font, font_weights) {
         ...
         * @return void
         */
        _populateFontSubsetsDropdown($thisClass, font_subsets) {
         ...
         * @return void
         */
        _setHeaderFontFromSavedValues($thisClass) {
         ...
         * @return void
         */
        _setStyleTagCSS($thisClass, font_family, font_path) {
         ...
         * @return void
         */
        _buildFontLink(font_family, font_weight = "") {
            let fontLink = "";
            if (font_weight.length > 0) {
