...
final class TabsMenu extends BaseContainer {
	...
	public function enqueueOptionScripts( array $container ) : void {
		...
		if ( Environment::isDevelopment() ) {
			wp_register_style( DHT_PREFIX_CSS . '-tabsmenu-container', DHT_ASSETS_URI . 'dist/css/tabsmenu.css', array(), dht()->manifest->get( 'version' ) );
			wp_enqueue_style( DHT_PREFIX_CSS . '-tabsmenu-container' );
			
			wp_enqueue_script( DHT_PREFIX_JS . '-tabsmenu-container', DHT_ASSETS_URI . 'dist/js/tabsmenu.js', array( 'jquery' ), dht()->manifest->get( 'version' ), true );
		}
	}
