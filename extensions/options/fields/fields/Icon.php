...
final class Icon extends BaseField {
	...
	public function enqueueOptionScripts( array $field ) : void {
		...
		//libraries icons css
		wp_register_style( DHT_PREFIX_CSS . '-font-awesome-css', DHT_ASSETS_URI . 'styles/libraries/fontawesome-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-font-awesome-css' );
		wp_register_style( DHT_PREFIX_CSS . '-divi-icons-css', DHT_ASSETS_URI . 'styles/libraries/divi-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-divi-icons-css' );
		wp_register_style( DHT_PREFIX_CSS . '-elusive-icons-css', DHT_ASSETS_URI . 'styles/libraries/elusive-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-elusive-icons-css' );
		wp_register_style( DHT_PREFIX_CSS . '-line-icons-css', DHT_ASSETS_URI . 'styles/libraries/line-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-line-icons-css' );
		wp_register_style( DHT_PREFIX_CSS . '-devicon-icons-css', DHT_ASSETS_URI . 'styles/libraries/devicon-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-devicon-icons-css' );
		wp_register_style( DHT_PREFIX_CSS . '-bootstrap-icons-css', DHT_ASSETS_URI . 'styles/libraries/bootstrap-icons.min.css', array(), dht()->manifest->get( 'version' ) );
		wp_enqueue_style( DHT_PREFIX_CSS . '-bootstrap-icons-css' );
		
		if ( Environment::isDevelopment() ) {
			wp_register_style( DHT_PREFIX_CSS . '-icon-field', DHT_ASSETS_URI . 'dist/css/icon.css', array(), dht()->manifest->get( 'version' ) );
			wp_enqueue_style( DHT_PREFIX_CSS . '-icon-field' );
			
			wp_enqueue_script( DHT_PREFIX_JS . '-icon-field', DHT_ASSETS_URI . 'dist/js/icon.js', array( 'jquery' ), dht()->manifest->get( 'version' ), true );
		}
	}
