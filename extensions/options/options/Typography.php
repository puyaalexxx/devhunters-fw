...
final class Typography extends BaseOption {
    ...
    public function enqueueOptionScripts( array $option ) : void {
        ...
        wp_register_style( DHT_PREFIX . '-typography-option', DHT_ASSETS_URI . 'styles/css/extensions/options/typography-style.css', array(), fw()->manifest->get( 'version' ) );
        ...
        wp_enqueue_script( DHT_PREFIX . '-typography-option', DHT_ASSETS_URI . 'scripts/js/extensions/options/typography-script.js', array( 'jquery', DHT_PREFIX . '-select2-option' ), fw()->manifest->get( 'version' ), true );
    }
    ...
    public function render( array $option ) : string {
        ...
        $standard_fonts = $this->_getStandardFonts();
        $standard_font_weights = $this->_getStandardFontWeights();
        $standard_font_styles = $this->_getStandardFontStyles();
        $text_decoration = $this->_getTextDecorationValues();
        $text_transform = $this->_getTextTransformValues();
