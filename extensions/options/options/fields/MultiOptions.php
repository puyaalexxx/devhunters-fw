...
final class MultiOptions extends BaseOption {
    ...
    public function enqueueOptionScripts( array $option ) : void {
        ...
        wp_register_style( DHT_PREFIX . '-multi-options-option', DHT_ASSETS_URI . 'styles/css/extensions/options/options/multi-options-style.css', array(), fw()->manifest->get( 'version' ) );
        ...
        wp_enqueue_script( DHT_PREFIX . '-multi-options-option', DHT_ASSETS_URI . 'scripts/js/extensions/options/options/multi-options-script.js', array( 'jquery', DHT_PREFIX . '-select2-option' ), fw()->manifest->get( 'version' ), true );
