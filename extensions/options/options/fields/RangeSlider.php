...
final class RangeSlider extends BaseField {
	...
	public function enqueueOptionScripts( array $field ) : void {
		...
		//library css
		wp_register_style( DHT_PREFIX_CSS . '-jquery-ui-rangeslider', DHT_ASSETS_URI . 'styles/libraries/jquery-ui-rangeslider.min.css', array(), dht()->manifest->get( 'version' ) );
		...
		if ( Environment::isDevelopment() ) {
			wp_register_style( DHT_PREFIX_CSS . '-rangeslider-field', DHT_ASSETS_URI . 'dist/css/rangeslider.css', array(), dht()->manifest->get( 'version' ) );
			wp_enqueue_style( DHT_PREFIX_CSS . '-rangeslider-field' );
			
			wp_enqueue_script( DHT_PREFIX_JS . '-rangeslider-field', DHT_ASSETS_URI . 'dist/js/rangeslider.js', array( 'jquery-ui-slider' ), dht()->manifest->get( 'version' ), true );
		}
	}
