    ...
    public function widgetAreaFormTemplate(): void {
        ...
        <div id="dht-wrap" class="dht-wrap" style="display:none;">
            <form method="post" action="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>">
                ...
                <button type="submit" name="create_sidebar" class="button-primary"><?php _ex('Create', 'widgets', 'dht'); ?></button>
            </form>
        </div>
        
        <div class="dht-wrap-delete" style="display:none;">
            <a href="#" style="display:none;" class="dht-widget-area-delete-confirm button-primary"><?php _ex('Confirm', 'widgets', 'dht'); ?></a>
            <a href="#" style="display:none;" class="dht-widget-area-delete-cancel button-secondary"><?php _ex('Cancel', 'widgets', 'dht'); ?></a>
            <a href="#" style="" class="dht-widget-area-delete button-primary"><?php _ex('Delete', 'widgets', 'dht'); ?></a>
        </div>
        <?php
    }
