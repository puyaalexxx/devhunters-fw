...
<?php do_action( 'dht_template_container_tabsmenu_before_area' ); ?>
    ...
    <div class="dht-tabsmenu-container <?php echo isset( $container[ 'attr' ][ 'class' ] ) ? esc_attr( $container[ 'attr' ][ 'class' ] ) : ''; ?>">
                ...
                foreach( $container[ 'options' ] as $tabsmenu ) : $count++; ?>
                    ...
                    <div class="dht-tabsmenu-content <?php echo $count == 1 ? 'active' : '' ?>"
                        ...
                        <?php if( !empty( $tabsmenu[ 'options' ] ) ): ?>
                            ...
                            echo dht_render_options( $tabsmenu[ 'options' ], $container[ 'id' ], $saved_value, $registered_options_classes );
                            ?>
