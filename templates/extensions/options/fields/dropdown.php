...
<?php do_action( 'dht_template_fields_dropdown_before_area' ); ?>
            ...
            <select class="dht-dropdown dht-field" name="<?php echo esc_attr( $field[ 'id' ] ); ?>"
                ...
                <?php foreach( $field[ 'choices' ] as $key => $val ): ?>
                        ...
                        <?php foreach( $val as $group ): ?>
                            ...
                            <optgroup label="<?php echo esc_attr( $group[ 'label' ] ); ?>">
                                ...
                                <?php foreach( $group[ 'choices' ] as $group_value => $group_label ): ?>
                                    ...
                                    <option value="<?php echo esc_attr( $group_value ); ?>" <?php echo ( $field[ 'value' ] == $group_value ) ? 'selected' : ''; ?>>
                    ...
                    <?php else: ?>
                        ...
                        <option value="<?php echo esc_attr( $key ); ?>" <?php echo ( $field[ 'value' ] == $key ) ? 'selected' : ''; ?>>
...
<?php do_action( 'dht_template_fields_dropdown_after_area' ); ?>
