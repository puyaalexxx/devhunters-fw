        ...
        <div class="dht-field-child-image-select-container">
            ...
            <?php if( !empty( $field[ 'choices' ] ) ): ?>
                ...
                foreach( $field[ 'choices' ] as $value => $radio ): ?>
                    ...
                    <div class="dht-img-select-wrapper <?php echo ( $field[ 'value' ] == $value ) ? 'dht-img-select-wrapper-selected' : ''; ?>">
                        ...
                        <label for="<?php echo esc_attr( $radio_id ); ?>"><?php echo esc_html( $radio[ 'label' ] ); ?></label>
...
<?php do_action( 'dht_template_fields_radio_image_after_area' ); ?>
