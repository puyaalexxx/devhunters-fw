...
<?php do_action( 'dht_template_fields_spacing_before_area' ); ?>
    ...
    <div class="dht-field-child-wrapper dht-field-child-spacing">
        ...
        <div class="dht-field-spacing-group">
            ...
            <div class="dht-field-spacing-input">
                ...
                <label for="<?php echo esc_attr( $field[ 'id' ] ); ?>-sizes"><?php echo _x( 'Sizes', 'options', DHT_PREFIX ); ?></label>
                ...
                <select class="dht-spacing-dropdown dht-field"
                    ...
                    <?php foreach( $sizes as $key => $size ): ?>
                        <option value="<?php echo esc_attr( $key ); ?>" <?php echo $field[ 'value' ][ 'size' ] == $key ? 'selected' : ''; ?>><?php echo esc_html( $size ); ?></option>
                    <?php endforeach; ?>
...
<?php do_action( 'dht_template_fields_spacing_after_area' ); ?>
