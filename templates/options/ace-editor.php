...
?>
    ...
    <div class="dht-field-wrapper">
        ...
        <div
            class="dht-field-child-wrapper dht-field-child-code-editor <?php echo isset( $args[ 'attr' ][ 'class' ] ) ? esc_attr( $args[ 'attr' ][ 'class' ] ) : ''; ?>"
            <?php echo dht_parse_option_attributes( $args[ 'attr' ] ); ?>>

            <label for="<?php echo esc_attr( $args[ 'id' ] ); ?>"><?php echo esc_html( $args[ 'label' ] ); ?></label>

            <textarea class="dht-ace-editor dht-field" id="<?php echo esc_attr( $args[ 'id' ] ); ?>"
                      name="<?php echo esc_attr( $args[ 'id' ] ); ?>"
                      style="display:none;"><?php echo esc_html( $args[ 'value' ] ); ?></textarea>
