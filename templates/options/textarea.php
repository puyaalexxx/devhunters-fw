...
?>
    ...
    <div class="dht-field-wrapper">
        ...
        <div class="dht-field-child-wrapper dht-field-child-textarea">
            ...
            <textarea
                class="dht-textarea dht-field <?php echo isset( $args[ 'attr' ][ 'class' ] ) ? esc_attr( $args[ 'attr' ][ 'class' ] ) : ''; ?>"
                id="<?php echo esc_attr( $args[ 'id' ] ); ?>"
                name="<?php echo esc_attr( $args[ 'id' ] ); ?>"
                placeholder="<?php echo esc_attr( $args[ 'default' ] ); ?>"
                rows="<?php echo !empty( $args[ 'row' ] ) ? esc_attr( $args[ 'row' ] ) : 6; ?>"
                      <?php echo dht_parse_option_attributes( $args[ 'attr' ] ); ?>><?php echo esc_html( $args[ 'value' ] ); ?></textarea>
