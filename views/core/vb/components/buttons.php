<div class="dht-vb-component-settings">
    <div class="dht-vb-buttons-container">
        <div class="dht-vb-button-group">
            <button type="button" data-tip="<?php _ex( 'Move Item', 'vb', DHT_PREFIX ); ?>"
                    class="dht-vb-button">
                <div class="dht-vb-icon dht-vb-icon-drag">
            ...
            <button type="button" data-tip="<?php _ex( 'Module Settings', 'vb', DHT_PREFIX ); ?>"
                    class="dht-vb-button">
                <div class="dht-vb-icon dht-vb-icon-setting">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
            ...
            <button type="button" data-tip="<?php _ex( 'Duplicate Module', 'vb', DHT_PREFIX ); ?>"
                    class="dht-vb-button">
                <div class="dht-vb-icon dht-vb-icon-duplicate">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
            ...
            <button type="button" data-tip="<?php _ex( 'Delete Module', 'vb', DHT_PREFIX ); ?>"
                    class="dht-vb-button">
                <div class="dht-vb-icon dht-vb-icon-delete">
            ...
            <button type="button"
                    data-tip="<?php _ex( 'Other Settings', 'vb', DHT_PREFIX ); ?>"
                    class="dht-vb-button">
                <div class="dht-vb-icon dht-vb-icon-other-setting">
