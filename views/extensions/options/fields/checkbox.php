...
<?php do_action( 'dht_template_fields_checkbox_before_area' ); ?>
            ...
            <?php if( !empty( $field[ 'choices' ] ) ): ?>
                ...
                <?php foreach( $field[ 'choices' ] as $key => $checkbox ): ?>
                    ...
                    <div class="dht-checkbox-wrapper">
                        ...
                        <label for="<?php echo esc_attr( $field[ 'id' ] . $checkbox[ 'id' ] ); ?>"><?php echo esc_html( $checkbox[ 'label' ] ); ?></label>
...
<?php do_action( 'dht_template_fields_checkbox_after_area' ); ?>