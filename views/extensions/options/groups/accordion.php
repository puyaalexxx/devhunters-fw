...
<?php do_action( 'dht_options_view_groups_accordion_before_area' ); ?>
                        ...
                        <div class="dht-accordion-content">
							...
							<?php if ( ! empty( $group_toggle[ 'options' ] ) ): ?>
								...
								<?php foreach ( $group_toggle[ 'options' ] as $toggle_option ) : ?>
									...
									echo dht_fw_render_group( $group[ 'id' ], $toggle_option, $saved_value, $registered_options_classes );
									?>
...
<?php do_action( 'dht_options_view_groups_accordion_after_area' ); ?>
